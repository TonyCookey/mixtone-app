        ...
        <div class="container">
            <div class="row people">
                <div class="col-md-5 col-lg-4 col-xl-3 item" style="height:573px;">
                   ...
                   <?php
                       ...
                       $query_number_of_posts = "select * from posts where user_id = '$user_id'";
                        ...
                        ?>
                        <p class="title" style="font-size:17px;margin-bottom:9px;"><?php echo $occupation;?></p><a class="d-block" href="user_posts.php?user_id=<?php echo $user_id;?>" data-aos="fade" style="font-size:13px;padding:5px;">Posts ( <?php echo $row_number_of_posts ?> )</a> <!-- <a class="d-block" href="messages.php" style="font-size:13px;padding:5px;">Messages (3)</a><a class="d-block" href="#" style="font-size:13px;padding:5px;">Following (13)</a>
                         <a
                ...
                <div class="col-md-7 col-lg-8 col-xl-8 offset-xl-0 item">
                    <div class="row">
                                <div class="col">
                                    <h3 class="text-center" style="margin-top:21px;margin-bottom:-23px;font-size:35px;"><em>Search Results</em></h3><br><br><br>
                           <?php search_user();?>
                                </div>
                            </div>
